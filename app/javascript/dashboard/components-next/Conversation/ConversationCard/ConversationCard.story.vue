...
const conversationWithoutMeta = {
  ...
  lastNonActivityMessage: {
    ...
    conversation: {
      ...
      contact_inbox: {
        source_id: 'candice@gladminds.co',
      },
    },
    sender: {
      id: 1,
