export const ONGOING_CAMPAIGN_EMPTY_STATE_CONTENT = [
  {
    ...
    trigger_rules: {
      url: 'https://gladminds.co/features/chatbot/',
      time_on_page: 10,
    },
  ...
  },
  {
    ...
    campaign_type: 'ongoing',
    trigger_rules: {
      url: 'https://gladminds.co/pricings',
      time_on_page: 10,
    },
...
export const ONE_OFF_CAMPAIGN_EMPTY_STATE_CONTENT = [
  {
    ...
    message:
      'Hello! Enjoying our product? Share your feedback on G2 and earn a $25 Amazon coupon: https://gladminds.co/g2-review',
    campaign_status: 'active',
    enabled: true,
