...
RSpec.describe Account do
  ...
  describe 'support_email' do
    ...
    it 'returns the support email from inbox if inbox value is present' do
      account.update(support_email: 'support@gladminds.co')
      with_modified_env MAILER_SENDER_EMAIL: 'hello@gladminds.co' do
        expect(account.support_email).to eq('support@gladminds.co')
      end
    end
    ...
    it 'returns the support email from ENV if inbox value is nil' do
      ...
      with_modified_env MAILER_SENDER_EMAIL: 'hello@gladminds.co' do
        expect(account.support_email).to eq('hello@gladminds.co')
      end
    end
